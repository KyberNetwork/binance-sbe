...
func (c *Car) Encode(_m *SbeGoMarshaller, _w io.Writer, doRangeCheck bool) error {
	...
	if err := _m.WriteUint64(_w, c.SerialNumber); err != nil {
		return err
	}
	...
	for idx := 0; idx < 4; idx++ {
		if err := _m.WriteUint32(_w, c.SomeNumbers[idx]); err != nil {
			return err
		}
	}
	...
	for i := range c.FuelFigures {
		if err := c.FuelFigures[i].Encode(_m, _w); err != nil {
			return err
		}
	}
	...
	for i := range c.PerformanceFigures {
		if err := c.PerformanceFigures[i].Encode(_m, _w); err != nil {
			return err
		}
	}
	...
	if err := _m.WriteUint32(_w, uint32(len(c.ActivationCode))); err != nil {
		return err
	}
	if err := _m.WriteBytes(_w, c.ActivationCode); err != nil {
		return err
	}
	return nil
}
...
func (c *Car) Decode(_m *SbeGoMarshaller, _r io.Reader, actingVersion uint16, blockLength uint16, doRangeCheck bool) error {
	if !c.SerialNumberInActingVersion(actingVersion) {
		...
		if err := _m.ReadUint64(_r, &c.SerialNumber); err != nil {
			return err
		}
	}
	...
	if !c.SomeNumbersInActingVersion(actingVersion) {
		...
		for idx := 0; idx < 4; idx++ {
			if err := _m.ReadUint32(_r, &c.SomeNumbers[idx]); err != nil {
				return err
			}
		}
	}
	...
	if c.ActivationCodeInActingVersion(actingVersion) {
		var ActivationCodeLength uint32
		if err := _m.ReadUint32(_r, &ActivationCodeLength); err != nil {
			return err
		}
		if cap(c.ActivationCode) < int(ActivationCodeLength) {
			c.ActivationCode = make([]uint8, ActivationCodeLength)
		}
		c.ActivationCode = c.ActivationCode[:ActivationCodeLength]
		if err := _m.ReadBytes(_r, c.ActivationCode); err != nil {
			return err
		}
	}
	if doRangeCheck {
...
func (c *Car) RangeCheck(actingVersion uint16, schemaVersion uint16) error {
	...
	if err := c.DiscountedModel.RangeCheck(actingVersion, schemaVersion); err != nil {
		return err
	}
	for i := range c.FuelFigures {
		if err := c.FuelFigures[i].RangeCheck(actingVersion, schemaVersion); err != nil {
			return err
		}
	}
	for i := range c.PerformanceFigures {
		if err := c.PerformanceFigures[i].RangeCheck(actingVersion, schemaVersion); err != nil {
			return err
		}
	}
	if !utf8.Valid(c.Manufacturer[:]) {
		return errors.New("c.Manufacturer failed UTF-8 validation")
	}
	if !utf8.Valid(c.Model[:]) {
		return errors.New("c.Model failed UTF-8 validation")
	}
	for idx, ch := range c.ActivationCode {
		if ch > 127 {
			return fmt.Errorf("c.ActivationCode[%d]=%d failed ASCII validation", idx, ch)
		}
	}
	return nil
}
...
func (c *CarFuelFigures) Encode(_m *SbeGoMarshaller, _w io.Writer) error {
	...
	if err := _m.WriteUint32(_w, uint32(len(c.UsageDescription))); err != nil {
		return err
	}
	if err := _m.WriteBytes(_w, c.UsageDescription); err != nil {
		return err
	}
	return nil
}
...
func (c *CarFuelFigures) Decode(_m *SbeGoMarshaller, _r io.Reader, actingVersion uint16, blockLength uint) error {
	...
	if c.UsageDescriptionInActingVersion(actingVersion) {
		var UsageDescriptionLength uint32
		if err := _m.ReadUint32(_r, &UsageDescriptionLength); err != nil {
			return err
		}
		if cap(c.UsageDescription) < int(UsageDescriptionLength) {
			c.UsageDescription = make([]uint8, UsageDescriptionLength)
		}
		c.UsageDescription = c.UsageDescription[:UsageDescriptionLength]
		if err := _m.ReadBytes(_r, c.UsageDescription); err != nil {
			return err
		}
	}
	return nil
...
func (c *CarFuelFigures) RangeCheck(actingVersion uint16, schemaVersion uint16) error {
	...
	for idx, ch := range c.UsageDescription {
		if ch > 127 {
			return fmt.Errorf("c.UsageDescription[%d]=%d failed ASCII validation", idx, ch)
		}
	}
	return nil
}
...
func (c *CarPerformanceFigures) Encode(_m *SbeGoMarshaller, _w io.Writer) error {
	...
	for i := range c.Acceleration {
		if err := c.Acceleration[i].Encode(_m, _w); err != nil {
			return err
		}
	}
	return nil
...
func (c *CarPerformanceFigures) RangeCheck(actingVersion uint16, schemaVersion uint16) error {
	...
	for i := range c.Acceleration {
		if err := c.Acceleration[i].RangeCheck(actingVersion, schemaVersion); err != nil {
			return err
		}
	}
	return nil
...
func (*Car) SbeSemanticVersion() (semanticVersion string) {
	return "5.2"
}
...
func (*Car) SerialNumberMinValue() uint64 {
	return 0
}

func (*Car) SerialNumberMaxValue() uint64 {
	return math.MaxUint64 - 1
}

func (*Car) SerialNumberNullValue() uint64 {
...
func (*Car) SomeNumbersMinValue() uint32 {
	return 0
}

func (*Car) SomeNumbersMaxValue() uint32 {
	return math.MaxUint32 - 1
}

func (*Car) SomeNumbersNullValue() uint32 {
...
func (*Car) DiscountedModelId() uint16 {
	return 8
}

func (*Car) DiscountedModelSinceVersion() uint16 {
	return 0
}

func (c *Car) DiscountedModelInActingVersion(actingVersion uint16) bool {
	return actingVersion >= c.DiscountedModelSinceVersion()
}

func (*Car) DiscountedModelDeprecated() uint16 {
	return 0
}

func (*Car) DiscountedModelMetaAttribute(meta int) string {
	switch meta {
	case 1:
		return ""
	case 2:
...
func (*CarFuelFigures) UsageDescriptionMetaAttribute(meta int) string {
	switch meta {
	case 1:
		return ""
	case 2:
...
func (*CarFuelFigures) UsageDescriptionSinceVersion() uint16 {
	return 0
}

func (c *CarFuelFigures) UsageDescriptionInActingVersion(actingVersion uint16) bool {
	return actingVersion >= c.UsageDescriptionSinceVersion()
}

func (*CarFuelFigures) UsageDescriptionDeprecated() uint16 {
	return 0
}

func (CarFuelFigures) UsageDescriptionCharacterEncoding() string {
	return "ASCII"
}

func (CarFuelFigures) UsageDescriptionHeaderLength() uint64 {
	return 4
}
...
func (*Car) ActivationCodeMetaAttribute(meta int) string {
	switch meta {
	case 1:
		return ""
	case 2:
...
func (*Car) ActivationCodeSinceVersion() uint16 {
	return 0
}

func (c *Car) ActivationCodeInActingVersion(actingVersion uint16) bool {
	return actingVersion >= c.ActivationCodeSinceVersion()
}

func (*Car) ActivationCodeDeprecated() uint16 {
	return 0
}

func (Car) ActivationCodeCharacterEncoding() string {
	return "ASCII"
}

func (Car) ActivationCodeHeaderLength() uint64 {
	return 4
}
